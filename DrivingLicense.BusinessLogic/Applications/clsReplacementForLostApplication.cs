...
{
    internal class clsReplacementForLostApplication : clsApplication
    {
        public clsReplacementForLostApplication() :base()
        {
            this.ApplicationType = Models.enApplicationType.ReplacementForALostDrivingLicense;
            this._Mode = enMode.AddNew;
        }

        public clsReplacementForLostApplication(int applicationID, enApplicationStatus applicationStatus, decimal paidFees, enApplicationType applicationType, int applicantPersonID, DateTime applicationDate, DateTime lastStatusDate, int createdByUserID) : base(applicationID, applicationStatus, paidFees, applicationType, applicantPersonID, applicationDate, lastStatusDate, createdByUserID)
        {
        ...
        public static clsReplacementForLostApplication FindByID(int replacementForDamageApplicationId)
        {
            ...
            return new clsReplacementForLostApplication
                (
        ...
        internal bool AddNewApplication(out string errorMessage)
        {
            ...
            this.ApplicationID = clsApplicationDataAccess.Insert
                (
                this.ApplicantPersonID, this.ApplicationDate, (int)enApplicationType.ReplacementForALostDrivingLicense,
